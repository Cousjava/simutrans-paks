...
{ global $LNG_LANGUAGE;
  ...
  { if ( $row['maintainer_user_id']  == $id || 
         $row['maintainer_user_id2'] == $id || 
         $row['maintainer_user_id3'] == $id || 
         $row['maintainer_user_id4'] == $id || 
         $row['maintainer_user_id5'] == $id || 
         $row['maintainer_user_id6'] == $id ) 
