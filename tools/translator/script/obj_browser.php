...
{ GLOBAL $v_att,$user, $LNG_OBJ_BROWSER,$LNG_MANAGE,$maintainter;
  $errg= ob_read($obj_id);
  if ($errg === NUll )  return;
  ...
  if ( in_array($errg->version_version_id,$maintainter))
...
{ GLOBAL $v_att,$LNG_EDIT, $LNG_FORM, $LNG_OBJ_BROWSER,$LNG_LOAD3;
