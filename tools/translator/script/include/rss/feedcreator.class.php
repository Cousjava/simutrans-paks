...
//	var $encoding = "ISO-8859-1";
	...
	function _createStylesheetReferences() {
		$xml = "";
		if ($this->cssStyleSheet) $xml .= "<?xml-stylesheet type=\"text/css\" href=\"".$this->cssStyleSheet."\" ?>\n";
		if ($this->xslStyleSheet) $xml .= "<?xml-stylesheet type=\"text/xsl\" href=\"".$this->xslStyleSheet."\" ?>\n";
		return $xml;
	}
...
class RSSCreator091 extends FeedCreator {
	...
	function createFeed() {
		...
		if ($this->pubDate!="") {
			...
			$feed.= "        <pubDate>".htmlspecialchars($pubDate->rfc822())." GMT</pubDate>\n";
		}
		if ($this->category!="") {
