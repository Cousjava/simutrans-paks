<?php
  ...
  { //If yes
    $enabled ="";
    foreach ($_SESSION['set_enabled'] as $id)
    { $enabled .= ' &nbsp;&nbsp;"'.$versions_all[$id].'"&nbsp;&nbsp; ';
    }
    $v_att['setstatus']['set_activ_yes'] = $LNG_MAIN[5];    
    $v_att['setstatus']['set_activ_yes_sets'] =  $enabled;    
/*
    $disabled ="";
    foreach ($_SESSION['set_disabled'] as $id)
    { $disabled .= ' &nbsp;&nbsp;"'.$id.'"&nbsp;&nbsp; ';
    }
  
    $v_att['setstatus']['set_activ_no'] = $LNG_MAIN[4];
    $v_att['setstatus']['set_activ_no_sets'] = $disabled; */
  }
