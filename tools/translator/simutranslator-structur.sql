...
CREATE TABLE IF NOT EXISTS `versions` (
  ...
  `tile_size` int(11) NOT NULL DEFAULT '64',
  `maintainer_user_id` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `maintainer_user_id2` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `maintainer_user_id3` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `maintainer_user_id4` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `maintainer_user_id5` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `maintainer_user_id6` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `activ` int(1) NOT NULL DEFAULT '0',
  `lng_disabled` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
