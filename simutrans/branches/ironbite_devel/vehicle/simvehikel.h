...
protected:
	...
	*/
	...
	slist_tpl<freight_t> fracht;   // liste der gerade transportierten g�ter
...
public:
	...
	*/
	...
	const slist_tpl<freight_t> & get_fracht() const { return fracht;}   // liste der gerade transportierten g�ter
