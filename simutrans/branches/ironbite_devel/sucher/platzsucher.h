 ...
 * mit x und y im Bereich [-max_xy;max_xy] au�er (0, 0) selber.
...
public:
	/**
	* @param max_xy (Maximalwert f�r x und y-Position)
	*
	* @author V. Meyer
	*/
 ...
 * pos_liste_wh_t:
 *
 * Erweiterte Version von pos_liste_t. Liefert die umliegenden Positionen f�r
