...
void display_shadow_50(int xpos, int ypos, int width, int height,  bool dirty);
void display_blend_50(int xpos, int ypos, int width, int height, int rgb, bool dirty);
