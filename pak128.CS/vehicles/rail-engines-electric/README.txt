...
DC
*	lokomotivy na stejnosměrný proud
	*	1.5kV=		(Bechyňka)
	*	3kV=		(CS, PL)

multi-system
*	vícesystémové lokomotivy (umí jezdit na střídavý i stejnosměrný proud)
	*	3kV= + 25kV~ 50Hz		 (363/362, 350)
	*	3kV= + 15kV~ 16.7Hz		 (372/371)
	*	3kV= + 25kV~ 50Hz + 15kV~ 16.7Hz (380/381)
	
*	lokomotivy na rozdílná napětí a frekvence třídavého proudu
