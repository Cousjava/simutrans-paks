...
$repo/makeobj PAK255 $repo/simutrans/PAK128.german/ ./ > "$repo/LOG/air.log" 2>> "$repo/LOG/error_air.log"
cd ../Passagiere_alt
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/air.log" 2>> "$repo/LOG/error_air.log"
cd ../Post
$repo/makeobj PAK255 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/air.log" 2>> "$repo/LOG/error_air.log"
cd ../Post_alt
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/air.log" 2>> "$repo/LOG/error_air.log"
...
cd ./monorail
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ > "$repo/LOG/monorail.log" 2> "$repo/LOG/error_monorail.log"
cd ../
echo "Erstelle Vehicle/Rail"
cd ./rail/Autos
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ > "$repo/LOG/rail.log" 2>> "$repo/LOG/error_rail.log"
cd ../catg_01
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/rail.log" 2>> "$repo/LOG/error_rail.log"
cd ../catg_02
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/rail.log" 2>> "$repo/LOG/error_rail.log"
...
mv ./*.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
cd ../Diesel
$repo/makeobj PAK128 >> "$repo/LOG/dieseloks.log" 2>> "$repo/LOG/error_dieseloks.log"
mv ./*.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd_dieseloks.log" 2>> "$repo/LOG/error_dieseloks.log"
cd ../Elek
...
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/rail.log" 2>> "$repo/LOG/error_rail.log"
cd ../Stahl
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/raillog_allgemein.log" 2>> "$repo/LOG/error_rail_allgemein.log"
cd ../Triebwagen/Akku
...
mv vehicle.Integral_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
...
mv vehicle.BR_477_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.BR_480_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.BR_481_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.BR_485_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.BR_485rot_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.ET_165_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.ICE_1_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.Flirt_all.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.ET25A.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.BZT_ET25B.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
mv vehicle.BZT_ET25C.pak $repo/simutrans/PAK128.german >> "$repo/LOG/cmd.log" 2>> "$repo/LOG/error_cmd.log"
...
cd ./road/Auto
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/road.log" 2>> "$repo/LOG/error_road.log"
cd ../catg_01
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/road.log" 2>> "$repo/LOG/error_road.log"
cd ../catg_02
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/road.log" 2>> "$repo/LOG/error_road.log"
...
cd ./tram/Passagiere
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/tram.log" 2>> "$repo/LOG/error_tram.log"
cd ../Fracht
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/tram.log" 2>> "$repo/LOG/error_tram.log"
cd ../Post
$repo/makeobj PAK128 $repo/simutrans/PAK128.german/ ./ >> "$repo/LOG/tram.log" 2>> "$repo/LOG/error_tram.log"
